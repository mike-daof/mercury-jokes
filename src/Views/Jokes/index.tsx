    ...
    <Page>
      <Stack divider={<Divider orientation="horizontal" flexItem />}>
        <Box className='h-32 flex justify-between items-center'>
          <Button onClick={onClickJoke} className='h-16 bg-lime-500 rounded-full' variant="contained" size="medium"><Typography className="capitalize">Get an new random joke</Typography></Button>
          <Link target="_blank" href="https://mwks-joke-service.azurewebsites.net/swagger/index.html">
            <Typography>View API Docs</Typography></Link>
        </Box>
        <Box>
          {renderResults()}
        </Box>
